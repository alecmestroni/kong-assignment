describe("Gateway Route Creation - Navigation Flow", () => {
  ...
  describe("Gateway Service Page - Alert Button", () => {
    it(
      "should redirect to route creation form with pre-selected service and redirect URL",
      { jiraKey: "KONG-5784" },
      () => {
        cy.visit(
  ...
  describe("Workspace Overview - Action Button", () => {
    it(
      "should redirect to route creation form with service selector visible and CTA parameter",
      { jiraKey: "KONG-3921" },
      () => {
        cy.visitHomePage();
  ...
  describe("Routes Page - Empty State Action", () => {
    it(
      "should redirect to route creation form with service selector visible",
      { jiraKey: "KONG-6203" },
      () => {
        cy.visit(
