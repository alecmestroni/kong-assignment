describe("Gateway Service Creation - Navigation Flow", () => {
  describe("Workspace Overview - Action Button", () => {
    it(
      "should redirect to service creation form with service selector visible and CTA parameter",
      { jiraKey: "KONG-8472" },
      () => {
        cy.visitHomePage();
  ...
  describe("Gateway Services Page - Empty State Action", () => {
    it(
      "should redirect to service creation form with service selector visible",
      { jiraKey: "KONG-5936" },
      () => {
        cy.visit(
