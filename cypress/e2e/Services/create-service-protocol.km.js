describe("Gateway Service Creation - Protocol Form", () => {
  ...
  describe("Form State and Validation", () => {
    ...
    it(
      "should show browser validation error when host field is empty",
      { jiraKey: "KONG-7261" },
      () => {
  ...
  describe("Server-side Validation", () => {
    it(
      "should show server error when required property is missing from request",
      { jiraKey: "KONG-3095" },
      () => {
  ...
  describe("Successful Service Creation", () => {
    it(
      "should create Gateway Service successfully with protocol form",
      { jiraKey: "KONG-6742" },
      () => {
        cy.compileProtocolForm();
